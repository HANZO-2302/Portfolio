      ...
      >
        <div className="relative flex h-full w-full items-center justify-center rounded-xl">
          ...
          >
            ...
            <h3
              className={`absolute text-xl transition-opacity duration-300 ${open ? 'opacity-0' : 'opacity-100'}`}
            >
              {title}
            </h3>
            ...
            >
              <p className="flex items-center justify-center p-4 text-left text-xs leading-snug font-light text-balance text-gray-800 dark:text-gray-200">
                {description}
              </p>
            </div>
          </motion.div>
    ...
    <div id="smooth-wrapper" className="will-change-transform">
      <div id="smooth-content" className="will-change-transform">
        <div className="flex min-h-screen flex-col">
              ...
              >
                ...
                <div className="gallery__item flex h-20 text-xl w-full items-center justify-center rounded-xl border border-zinc-500 bg-zinc-400 shadow-lg dark:border-gray-600 dark:bg-gray-800/80">
                  <Image
                    ...
                    width={65}
                    height={65}
                    className="p-3 drop-shadow-xs/90"
                  />
                  Docker
                </div>
                <div className="gallery__item flex h-20 text-xl w-full items-center justify-center rounded-xl border border-zinc-500 bg-zinc-400 shadow-lg dark:border-gray-600 dark:bg-gray-800/80">
                ...
                <div className="gallery__item flex h-20 text-xl w-full items-center justify-center rounded-xl border border-zinc-500 bg-zinc-400 shadow-lg dark:border-gray-600 dark:bg-gray-800/80">
                  ...
                  <svg
                    ...
                    fill="currentColor"
                    xmlns="http://www.w3.org/2000/svg"
                    className="relative -left-2 size-18 drop-shadow-xs/20"
                  >
                    <path
                ...
                <div className="gallery__item flex h-20 text-xl w-full items-center justify-center rounded-xl border border-zinc-500 bg-zinc-400 shadow-lg dark:border-gray-600 dark:bg-gray-800/80">
                  ...
                  <span className="mx-4 h-6 border-l border-gray-600 dark:border-gray-500"></span>
                  <span className="px-0">MySQL</span>
                  <Image
                    src="/mysql.svg"
                    alt=""
                    width={65}
          ...
          <div data-speed="1.5" className="geekbrains h-0 -translate-y-80 p-4">
            <GeekBrains />
          </div>
          <Footer />
        </div>

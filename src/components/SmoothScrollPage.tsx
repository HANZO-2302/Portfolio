      ...
      >
        <div className="relative flex h-full w-full items-center justify-center">
          <motion.div className="flex items-center justify-center" whileTap={{ scale: 0.95 }}>
            ...
            >
              <p className="flex items-center justify-center p-3 text-left text-[15px] font-light text-gray-600 transition-opacity duration-500 select-none dark:text-gray-300">
                {description}
              </p>
            </div>
          </motion.div>
      ...
      <div id="smooth-content" className="will-change-transform">
        <div className="flex min-h-screen flex-col">
          ...
          >
            ...
            >
              ...
              <div className="mt-5 w-full text-center md:mt-0">
                ...
                >
                  <p className="aboutText text-center text-[14px] leading-relaxed whitespace-pre-line text-gray-900 will-change-transform md:text-[17px] lg:text-2xl dark:text-gray-100">
                    {aboutText}
                  </p>
                </motion.div>
              </div>
          ...
          >
            <div
              data-speed="0.9"
              className="hero-footer mx-auto mt-15 grid w-full max-w-6xl grid-cols-2 gap-4 rounded-3xl border border-gray-400/70 bg-gray-300 p-4 text-[14px] shadow-xl backdrop-blur-md transition-colors md:grid-cols-3 md:px-4 md:text-lg dark:border-gray-600 dark:bg-gray-800/80"
            >
              {/* Telegram */}
              <Link
                ...
                className="group ml-2 flex items-center gap-1 text-gray-700 transition hover:text-blue-500 dark:text-gray-200 dark:hover:text-blue-400"
              >
                <Send className="h-5 w-5 transition group-hover:scale-110" />
                <span>@Igor_Menyailov</span>
              </Link>
              {/* Email */}
              <a
                href="mailto:m2302835@gmail.com"
                className="group flex items-center gap-1 text-gray-700 transition hover:text-blue-500 dark:text-gray-200 dark:hover:text-blue-400"
              >
                <Mail className="h-5 w-5 transition group-hover:scale-110" />
                <span>m2302835@gmail.com</span>
              </a>
              ...
              <Link
                href="/resume.pdf"
                download
                className="group col-span-2 flex items-center justify-center gap-2 rounded-xl border border-blue-500 px-4 py-2 text-blue-500 transition hover:bg-blue-500 hover:text-white md:col-auto"
              >
          ...
          <motion.div
            ...
            className="hero-arrows relative mt-5 px-4 md:translate-y-[20px]"
          >
            <div
              data-speed="0.9"
              className="mx-auto flex h-10 w-full max-w-40 items-center justify-center gap-3 rounded-full text-xl uppercase opacity-90"
            >
              <div className="flex justify-center">
                <div className="relative flex h-6 w-6 animate-bounce items-center justify-center rounded-full border-2 border-orange-500 shadow-xs/90">
                  <svg
                    aria-hidden="true"
          ...
          <div className="portfolio mt-15 flex flex-col items-center justify-center">
            <div className="container mx-auto">
              <main className="gallery mx-auto mt-20 grid w-full max-w-6xl grid-cols-1 justify-items-center gap-x-2 px-4 pb-80 md:mt-30 md:grid-cols-2">
                ...
                <div
                  data-speed="0.9"
                  className="gallery__left flex w-full max-w-md flex-col items-center justify-center gap-y-4 overflow-hidden pb-40 text-2xl font-medium text-gray-800 will-change-transform dark:text-gray-200"
                >
                  {/* <motion.div
                  ...
                  <div className="gallery__item flex h-20 w-full items-center justify-center rounded-xl border shadow-xl">
                    ...
                    <span className="mx-0 h-6 border-l border-gray-600 dark:border-gray-400"></span>
                ...
                <div
                  data-speed="0.9"
                  className="gallery__right flex w-full max-w-md flex-col gap-y-4 overflow-hidden pb-40 text-2xl text-gray-800 will-change-transform dark:text-gray-200"
                >
                  <div className="gallery__item mt-50 flex w-full items-center justify-center text-6xl font-bold md:mt-0 md:text-6xl">
                    Soft Skills
                  </div>

  ...
  return (
    <footer className="relative z-40 flex w-full bg-gray-200 py-6 text-gray-100 transition-colors duration-50 dark:bg-gray-800 dark:duration-50">
      ...
      <div className="container mx-auto flex flex-wrap items-center justify-center gap-2 px-5">
        ...
        <a
          className="flex items-center gap-2 px-4 py-1 font-extralight tracking-tighter text-gray-800 dark:text-gray-200"
        ...
        >
          <svg
            ...
            className="h-auto w-6 text-gray-800 drop-shadow-xs/70 transition-all duration-500 group-hover:scale-50 group-hover:opacity-0 dark:text-gray-200"
          >
            <path
